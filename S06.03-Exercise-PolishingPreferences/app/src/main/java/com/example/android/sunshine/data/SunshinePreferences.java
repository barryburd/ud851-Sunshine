...
public class SunshinePreferences {
    ...
    public static String getPreferredWeatherLocation(Context context) {
        ...
        String location = sharedPreferences.getString(context.getResources().getString(R.string.pref_location_key) , getDefaultWeatherLocation());
    ...
    public static boolean isMetric(Context context) {
        ...
        /** This will be implemented in a future lesson **/
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        String isMetricString = sharedPreferences.getString(context.getResources().getString(R.string.pref_units_key), context.getResources().getString(R.string.pref_units_metric));
        System.out.println("isMetricString: " + isMetricString);
        return isMetricString == context.getResources().getString(R.string.pref_units_metric);
    }
