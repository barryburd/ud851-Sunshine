...
//      TODO (7) Generate a weather summary with the date, description, high and low
       /* String dateString = mCursor.getString(mCursor.getColumnIndex(WeatherContract.WeatherEntry.COLUMN_DATE));
        String description = mCursor.getString(mCursor.getColumnIndex(WeatherContract.WeatherEntry.COLUMN_HUMIDITY)); /////?????
        ...
        String highAndLowTemperature = "High: " + highInCelsius + " Low: " + lowInCelsius;
...
//      TODO (12) After the new Cursor is set, call notifyDataSetChanged
    ...
    class ForecastAdapterViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            String weatherForDay = weatherSummary.getText().toString(); //mWeatherData[adapterPosition];
