...
import com.example.android.sunshine.databinding.ExtraWeatherDetailBinding;
...
//  TODO (3) Declare an ActivityDetailBinding field called mDetailBinding
 //   ActivityDetailBinding mDetailBinding;
    PrimaryWeatherInfoBinding mPrimaryWeatherInfoBinding;
    ExtraWeatherDetailBinding mExtraWeatherDetailBinding;
...
//      TODO (6) Instantiate mDetailBinding using DataBindingUtil
     //   mDetailBinding = DataBindingUtil.setContentView(this, R.layout.activity_detail);
        mPrimaryWeatherInfoBinding = DataBindingUtil.setContentView(this, R.layout.primary_weather_info);
        mExtraWeatherDetailBinding = DataBindingUtil.setContentView(this, R.layout.extra_weather_detail);
...
//      TODO (8) Use mDetailBinding to display the date
 //       mDetailBinding.mDateView.setText(dateText);
        mPrimaryWeatherInfoBinding.textViewDate.setText(dateText);
...
//      TODO (9) Use mDetailBinding to display the description and set the content description
 ...
 //       mDetailBinding.mDescriptionView.setText(description);
        mPrimaryWeatherInfoBinding.textViewDescription.setContentDescription(desc1);

//      TODO (16) Set the content description of the icon to the same as the weather description a11y text
  //      mDetailBinding.mDescriptionView.setContentDescription(desc1);
...
//      TODO (10) Use mDetailBinding to display the high temperature and set the content description
   ...
   //     mDetailBinding.mHighTemperatureView.setText(highString);
...
//      TODO (12) Use mDetailBinding to display the humidity and set the content description
   ...
   //     mDetailBinding.mHumidityView.setText(humidityString);
...
//      TODO (13) Use mDetailBinding to display the wind and set the content description
  ...
  //      mDetailBinding.mWindView.setText(windString);
...
//      TODO (14) Use mDetailBinding to display the pressure and set the content description
   ...
   //     mDetailBinding.mPressureView.setText(pressureString);
